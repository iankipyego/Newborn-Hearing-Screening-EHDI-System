...
1. **`lib/pathway/engine.ts` must have zero imports from `db/`, `app/`, or any network layer.** It takes typed data objects and returns typed results. This keeps it unit-testable and reviewable by a non-engineer.
